...
export default {
  ...
  data() {
    return {
      paths: [
        { name: '报告审核', url: '/business-review-list-risk', present: false },
        { name: '项目详情', url: `/business-review-detail-risk-${this.$route.params.id}`, present: true },
      ],
      business: {
...
remark: rep.data.data.projectBillingArray[i].annexArray[j].remark
    ...
    approved(id) {
      ...
      this.business.projectStatus = 40;
    ...
    refused(id, reason) {
      ...
      this.business.projectApproverArray.push(obj);
      this.riskAdvices.push(obj);
      this.business.projectStatus = 30;
