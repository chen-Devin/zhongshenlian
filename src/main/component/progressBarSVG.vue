<template>
  <div class="svg-wrap">
    ...
    <svg width="1000" height="150">
      ...
      <line x1="500" y1="60" x2="500" y2="60" style="stroke-width:1" :style="{stroke: passed(progress[4].passed).linCol}"></line>
      ...
      <line x1="600" y1="60" x2="500" y2="60" style="stroke-width:1" :style="{stroke: passed(progress[5].passed).linCol}"></line>
