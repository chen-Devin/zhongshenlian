...
export default {
  ...
  mounted() {
    if (this.user.department === '业务部') {
      ...
      this.paths.push({ name: '项目详情', url: `/business-handle-detail-sales-${this.$route.params.id}/operat-history`, present: false });
      ...
      this.paths.push({ name: '项目详情', url: `/business-handle-detail-risk-${this.$route.params.id}/operat-history`, present: false });
      ...
      this.paths.push({ name: '项目详情', url: `/business-handle-detail-leader-${this.$route.params.id}/operat-history`, present: false });
      ...
      this.paths.push({ name: '项目详情', url: `/business-handle-detail-office-${this.$route.params.id}/operat-history`, present: false });
      ...
      this.paths.push({ name: '项目详情', url: `/business-handle-detail-financial-${this.$route.params.id}/operat-history`, present: false });
      ...
      this.paths.push({ name: '项目详情', url: `/business-handle-detail-archives-${this.$route.params.id}/operat-history`, present: false });
